...
class ProxyAdmin {
    ...
    private static function validateAuth() {
        if (!isset($_SESSION["SuperAdministrador"])) {
            ...
            self::$auth = json_decode($_SESSION["SuperAdministrador"]);
        }
    }
    ...
    public static function main() {
        ...
        require_once "{$config->get('class')}Paginacion.php";
        ...
        $path_controller = "{$config->get("controllers")}admin/{$clscontroller}.php";
